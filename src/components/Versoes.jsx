...
const Versoes = () => {
  return (
    <Flex direction={{ base: 'column', lg: 'row' }} bg='#F0EAFB' pb='100px'>
        ...
        <Box w={{ base: '350px', lg: '500px' }} p='30px' bg='white' maxW='500px' margin='auto' mt={{ base: '50px', lg: '-100px' }} borderRadius='12px' overflow='hidden'boxShadow='0px 20px 25px -5px rgba(0, 0, 0, 0.1), 0px 10px 10px -5px rgba(0, 0, 0, 0.04)' textAlign='center'>
            <Flex direction='column' align='center' justify='center'>
